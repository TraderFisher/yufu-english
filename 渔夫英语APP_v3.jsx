...
const DEFAULT_RAW = [
  ...
  // ── 办公软件 ──────────────────────────────────────────────────────────────
  [621,"Paragraph","PAIR-uh-graf","段落","办公软件","Select the paragraph and change the font size.","选中段落并更改字体大小。"],
  [622,"Indent","IN-dent","缩进","办公软件","Indent the first line of each paragraph.","每个段落的第一行缩进。"],
  [623,"Alignment","uh-LYN-ment","对齐方式","办公软件","Set the alignment to center for the title.","将标题的对齐方式设置为居中。"],
  [624,"Bullet Point","BUL-it point","项目符号","办公软件","Use bullet points to list your key ideas.","使用项目符号列出你的主要想法。"],
  [625,"Numbered List","NUM-berd list","编号列表","办公软件","Switch to a numbered list for step-by-step instructions.","切换为编号列表以呈现分步说明。"],
  [626,"Header","HED-er","页眉 / 标题","办公软件","Add the company name to the header of each page.","将公司名称添加到每页的页眉。"],
  [627,"Footer","FUT-er","页脚","办公软件","Insert page numbers in the footer.","在页脚中插入页码。"],
  [628,"Page Break","payj brayk","分页符","办公软件","Insert a page break to start a new section.","插入分页符以开始新的章节。"],
  [629,"Table of Contents","TAY-bul uv KON-tents","目录","办公软件","Generate a table of contents automatically.","自动生成目录。"],
  [630,"Font","font","字体","办公软件","Change the font to make the text easier to read.","更改字体使文字更易于阅读。"],
  [631,"Font Size","font syz","字号","办公软件","Increase the font size for better visibility.","增大字号以提高可读性。"],
  [632,"Bold","bohld","粗体","办公软件","Make the heading bold to stand out.","将标题加粗以突出显示。"],
  [633,"Italic","ih-TAL-ik","斜体","办公软件","Use italic for titles of books or films.","书籍或电影标题使用斜体。"],
  [634,"Underline","UN-der-lyne","下划线","办公软件","Underline the key terms in the document.","在文档中的关键术语下加下划线。"],
  [635,"Highlight","HY-lyt","高亮标注","办公软件","Highlight the important sentences in yellow.","用黄色高亮重要句子。"],
  [636,"Word Count","werd kownt","字数统计","办公软件","Check the word count before submitting your report.","提交报告之前检查字数统计。"],
  [637,"Track Changes","trak CHAYN-jiz","修订追踪","办公软件","Turn on Track Changes so reviewers can see edits.","打开修订追踪，让审阅者可以看到编辑内容。"],
  [638,"Comment","KOM-ent","批注","办公软件","Add a comment to explain why you made the change.","添加批注解释你为什么做出这个更改。"],
  [639,"Spell Check","spel chek","拼写检查","办公软件","Run spell check before sending the document.","发送文档之前运行拼写检查。"],
  [640,"Autosave","AW-toh-sayv","自动保存","办公软件","Autosave protects your work if the app crashes.","如果应用崩溃，自动保存会保护你的工作。"],
  [641,"Slide","slyd","幻灯片","办公软件","Add a new slide for each main point.","为每个主要观点添加一张新幻灯片。"],
  [642,"Animation","an-ih-MAY-shun","动画效果","办公软件","Add an animation to make the slide more engaging.","添加动画使幻灯片更生动。"],
  [643,"Speaker Notes","SPEE-ker nohts","演讲者备注","办公软件","Write your talking points in the speaker notes.","在演讲者备注中写下你的讲话要点。"],
  [644,"VLOOKUP","vee-LOOK-up","VLOOKUP查找函数","办公软件","Use VLOOKUP to find a value in another table.","使用VLOOKUP在另一个表格中查找值。"],
  [645,"Filter","FIL-ter","筛选","办公软件","Apply a filter to show only sales above $1000.","应用筛选以只显示销售额超过1000美元的记录。"],
  [646,"Sort","sort","排序","办公软件","Sort the data by date in ascending order.","按日期升序对数据进行排序。"],
  [647,"Freeze Panes","freez paynz","冻结窗格","办公软件","Freeze the top row so the headers always show.","冻结顶行，让标题始终显示。"],
  [648,"Macro","MAK-roh","宏（自动化操作）","办公软件","Record a macro to automate repetitive tasks.","录制宏以自动化重复性任务。"],
  [649,"Wrap Text","rap tekst","自动换行","办公软件","Enable wrap text so the content fits in the cell.","启用自动换行，让内容适合单元格。"],
  [650,"Data Validation","DAY-tuh val-ih-DAY-shun","数据验证","办公软件","Use data validation to restrict input to a dropdown list.","使用数据验证将输入限制为下拉列表。"],
  [651,"Print Preview","print PREE-vyoo","打印预览","办公软件","Check print preview before printing the document.","在打印文档之前检查打印预览。"],
  [652,"Protect Sheet","pruh-TEKT sheet","保护工作表","办公软件","Protect the sheet to prevent accidental edits.","保护工作表以防止意外编辑。"],
  [653,"Named Range","naymd raynj","命名区域","办公软件","Define a named range to use in your formulas.","定义命名区域以在公式中使用。"],

  // ── 视频创作 ──────────────────────────────────────────────────────────────
  [654,"B-roll","BEE-rohl","补充镜头（B-roll）","视频创作","Add B-roll footage to make the video more dynamic.","添加补充镜头使视频更具动感。"],
  [655,"Color Grading","KUL-er GRAY-ding","调色","视频创作","Color grading gives your video a cinematic look.","调色赋予你的视频电影感。"],
  [656,"LUT","lut","颜色预设（查找表）","视频创作","Apply a LUT to instantly change the color mood.","应用LUT即时改变色彩风格。"],
  [657,"Voice Over","voys OH-ver","旁白配音","视频创作","Record a voice over to narrate the video.","录制旁白为视频进行解说。"],
  [658,"Green Screen","green skreen","绿幕（抠图）","视频创作","Shoot on a green screen to replace the background.","在绿幕前拍摄以替换背景。"],
  [659,"Motion Graphics","MOH-shun GRAF-iks","动态图形","视频创作","Add motion graphics to display key statistics.","添加动态图形来展示关键数据。"],
  [660,"Lower Third","LOH-er therd","下三分之一角标","视频创作","Use a lower third to show the speaker's name.","使用下角标显示说话者的名字。"],
  [661,"Aspect Ratio","AS-pekt RAY-shee-oh","画面比例","视频创作","Change the aspect ratio to 9:16 for vertical video.","将画面比例改为9:16用于竖版视频。"],
  [662,"Resolution","rez-uh-LOO-shun","分辨率","视频创作","Export at 4K resolution for the best quality.","以4K分辨率导出以获得最佳质量。"],
  [663,"Frame Rate","fraym rayt","帧率","视频创作","Shoot at 60fps for smooth slow-motion playback.","以60fps拍摄以获得流畅的慢动作回放。"],
  [664,"Bitrate","BIT-rayt","码率","视频创作","A higher bitrate results in better video quality.","更高的码率带来更好的视频质量。"],
  [665,"Encoding","en-KOH-ding","编码","视频创作","Use H.264 encoding for wide compatibility.","使用H.264编码以获得广泛兼容性。"],
  [666,"Sequence","SEE-kwens","剪辑序列","视频创作","Create a new sequence with the correct settings.","使用正确的设置创建一个新序列。"],
  [667,"Fade In","fayd in","淡入","视频创作","Start with a fade in for a smooth opening.","以淡入开头营造流畅的开场效果。"],
  [668,"Fade Out","fayd owt","淡出","视频创作","End the video with a fade out to black.","以淡出至黑色结束视频。"],
  [669,"Speed Ramp","speed ramp","速度变化（升降格）","视频创作","Use a speed ramp to add dramatic effect.","使用速度变化添加戏剧性效果。"],
  [670,"Stabilize","STAY-bih-lyz","视频防抖","视频创作","Stabilize the shaky footage in post-production.","在后期制作中稳定抖动的镜头。"],
  [671,"Color Correction","KUL-er kuh-REK-shun","色彩校正","视频创作","Color correction fixes exposure and white balance issues.","色彩校正修复曝光和白平衡问题。"],
  [672,"Sound Effect","sownd ih-FEKT","音效","视频创作","Add a sound effect to make the transition pop.","添加音效使转场更生动。"],
  [673,"Audio Mix","AW-dee-oh miks","音频混合","视频创作","Balance the audio mix between music and voice.","平衡音乐和声音之间的音频混合。"],
  [674,"Render Queue","REN-der kyoo","渲染队列","视频创作","Add multiple projects to the render queue.","将多个项目添加到渲染队列。"],
  [675,"Proxy","PROK-see","代理文件（剪辑加速）","视频创作","Use proxy files to edit 4K footage on a slow computer.","使用代理文件在低配电脑上剪辑4K素材。"],
  [676,"Cut","kut","硬切（剪辑）","视频创作","Make a clean cut between the two scenes.","在两个场景之间进行干净的硬切。"],
  [677,"Denoise","dee-NOYZ","降噪","视频创作","Apply denoise to fix grainy low-light footage.","应用降噪修复低光环境下的噪点素材。"],
  [678,"Trim","trim","修剪片段","视频创作","Trim the beginning and end of each clip.","修剪每个片段的开头和结尾。"],

  // ── 视频平台创作后台 ────────────────────────────────────────────────────
  [679,"Upload","UP-lohd","上传","软件操作","Upload the finished video to YouTube.","将完成的视频上传到YouTube。"],
  [680,"Visibility","viz-ih-BIL-ih-tee","可见性（公开/私密）","软件操作","Set visibility to Public when the video is ready.","视频准备好后将可见性设置为公开。"],
  [681,"Scheduled","SKEJ-oold","定时发布","软件操作","Schedule the video to publish at 9 AM tomorrow.","将视频定时安排在明天早上9点发布。"],
  [682,"Description","dih-SKRIP-shun","视频/内容描述","软件操作","Write a clear description with keywords for SEO.","为SEO写一个包含关键词的清晰描述。"],
  [683,"Tags","tagz","标签","软件操作","Add relevant tags to help the algorithm find your video.","添加相关标签帮助算法发现你的视频。"],
  [684,"CPM","see-pee-em","每千次展示收入","软件操作","A high CPM means advertisers pay more for your audience.","高CPM意味着广告商为你的受众付出更多。"],
  [685,"RPM","ar-pee-em","每千次播放实际收入","软件操作","RPM is the money you actually earn per 1000 views.","RPM是你每1000次观看实际赚取的金额。"],
  [686,"Click-through Rate","klik-THROO rayt","点击率（CTR）","软件操作","A good thumbnail can double your click-through rate.","好的封面图可以使你的点击率翻倍。"],
  [687,"Watch Time","woch tym","观看时长","软件操作","Watch time is the most important metric for YouTube growth.","观看时长是YouTube增长最重要的指标。"],
  [688,"Average View Duration","AV-er-ij vyoo dyoo-RAY-shun","平均观看时长","软件操作","Improve your average view duration by getting to the point faster.","通过更快切入主题来提高平均观看时长。"],
  [689,"End Screen","end skreen","片尾屏幕","软件操作","Add an end screen to promote your other videos.","添加片尾屏幕来推广你的其他视频。"],
  [690,"Playlist","PLAY-list","播放列表","软件操作","Organize your videos into playlists by topic.","按主题将你的视频整理到播放列表中。"],
  [691,"Live Stream","lyv streem","直播","软件操作","Go live to interact with your audience in real time.","开直播与你的观众实时互动。"],
  [692,"Chapter","CHAP-ter","视频章节","软件操作","Add chapters to help viewers navigate the video.","添加章节帮助观众导航视频。"],
  [693,"Demonetized","dee-MON-ih-tyzd","被取消变现资格","软件操作","The video was demonetized for violating ad policies.","这个视频因违反广告政策而被取消变现资格。"],
  [694,"Copyright Claim","KOP-ee-rit klaym","版权申诉","软件操作","Fight a copyright claim if you believe your use is fair.","如果你认为你的使用是合理的，请对版权申诉提出异议。"],
  [695,"Strike","stryk","违规警告","软件操作","Three strikes will result in channel termination.","三次违规警告将导致频道终止。"],
  [696,"Community Post","kyoo-MYOO-nih-tee pohst","社区帖子","软件操作","Use community posts to engage with subscribers between videos.","在视频之间使用社区帖子与订阅者互动。"],
  [697,"Shorts","shorts","短视频（竖屏）","软件操作","Post a Short under 60 seconds to reach new viewers.","发布60秒以内的短视频以接触新观众。"],

  // ── 通用UI界面词汇 ───────────────────────────────────────────────────────
  [698,"Scroll","skrohl","滚动","软件操作","Scroll down to see more content.","向下滚动查看更多内容。"],
  [699,"Zoom In","zoom in","放大","软件操作","Zoom in to see the details more clearly.","放大以更清楚地看到细节。"],
  [700,"Zoom Out","zoom owt","缩小","软件操作","Zoom out to see the full picture.","缩小查看完整画面。"],
  [701,"Drag and Drop","drag and drop","拖放操作","软件操作","Drag and drop the file into the upload area.","将文件拖放到上传区域。"],
  [702,"Double Click","DUB-ul klik","双击","软件操作","Double click the file to open it.","双击文件将其打开。"],
  [703,"Right Click","ryt klik","右键点击","软件操作","Right click to open the context menu.","右键点击打开右键菜单。"],
  [704,"Hover","HUV-er","鼠标悬停","软件操作","Hover over the icon to see the tooltip.","将鼠标悬停在图标上查看提示。"],
  [705,"Swipe","swyp","滑动（触屏）","软件操作","Swipe left to go back to the previous screen.","向左滑动返回上一屏幕。"],
  [706,"Pop-up","POP-up","弹出窗口","软件操作","A pop-up appeared asking for your permission.","弹出了一个请求你许可的窗口。"],
  [707,"Tab","tab","标签页","软件操作","Open a new tab to browse without losing your place.","打开新标签页浏览而不失去当前位置。"],
  [708,"Sidebar","SYD-bar","侧边栏","软件操作","The settings are in the left sidebar.","设置在左侧边栏中。"],
  [709,"Loading","LOH-ding","加载中","软件操作","The page is loading — please wait.","页面正在加载——请等待。"],
  [710,"Error Message","EHR-er MES-ij","错误信息","软件操作","Read the error message carefully to understand the problem.","仔细阅读错误信息以了解问题所在。"],
  [711,"Warning","WOR-ning","警告","软件操作","A warning appeared before I deleted the file.","在我删除文件之前出现了一个警告。"],
  [712,"Confirm","kun-FERM","确认","软件操作","Click Confirm to proceed with the action.","点击确认继续执行操作。"],
  [713,"Submit","sub-MIT","提交","软件操作","Click Submit when you are ready to send the form.","准备好发送表单时点击提交。"],
  [714,"Reset","ree-SET","重置","软件操作","Click Reset to restore the default settings.","点击重置恢复默认设置。"],
  [715,"Refresh","rih-FRESH","刷新页面","软件操作","Refresh the page if the content doesn't load.","如果内容未加载，刷新页面。"],
  [716,"Search Bar","serch bar","搜索栏","软件操作","Type your query in the search bar.","在搜索栏中输入你的查询内容。"],
  [717,"Collapse","kuh-LAPS","折叠","软件操作","Collapse the menu to save screen space.","折叠菜单以节省屏幕空间。"],
  [718,"Expand","ek-SPAND","展开","软件操作","Click the arrow to expand the section.","点击箭头展开该部分。"],
  [719,"Fullscreen","FUL-skreen","全屏","软件操作","Press F11 to toggle fullscreen mode.","按F11切换全屏模式。"],
  [720,"Minimize","MIN-ih-myz","最小化","软件操作","Minimize the window to keep it running in the background.","最小化窗口使其在后台继续运行。"],
  [721,"Undo","un-DOO","撤销","软件操作","Press Ctrl+Z to undo your last action.","按Ctrl+Z撤销上一步操作。"],
  [722,"Redo","ree-DOO","重做","软件操作","Press Ctrl+Y to redo the action you just undid.","按Ctrl+Y重做你刚刚撤销的操作。"],
  [723,"Copy","KOP-ee","复制","软件操作","Copy the text and paste it into the new document.","复制文字并粘贴到新文档中。"],
  [724,"Paste","payst","粘贴","软件操作","Paste the link into the address bar.","将链接粘贴到地址栏中。"],
  [725,"Select All","suh-LEKT awl","全选","软件操作","Press Ctrl+A to select all the text.","按Ctrl+A全选所有文字。"],
  [726,"Breadcrumb","BRED-krum","面包屑导航","软件操作","The breadcrumb shows you where you are in the site.","面包屑导航显示你在网站中的位置。"],
  [727,"Pagination","paj-ih-NAY-shun","分页","软件操作","Use pagination to navigate through multiple pages of results.","使用分页浏览多页结果。"],

  // ── 邮件 / 账户通用 ──────────────────────────────────────────────────────
  [728,"Inbox","IN-boks","收件箱","软件操作","Check your inbox for the confirmation email.","检查你的收件箱查看确认邮件。"],
  [729,"Draft","draft","草稿","软件操作","Save it as a draft and finish it later.","将其保存为草稿，稍后完成。"],
  [730,"Spam","spam","垃圾邮件","软件操作","Check your spam folder if you didn't receive the email.","如果没有收到邮件，请检查你的垃圾邮件文件夹。"],
  [731,"Archive","AR-kyv","归档","软件操作","Archive old emails to keep your inbox clean.","归档旧邮件保持收件箱整洁。"],
  [732,"Reply","rih-PLY","回复","软件操作","Reply to the email as soon as possible.","尽快回复邮件。"],
  [733,"Forward","FOR-werd","转发","软件操作","Forward the email to the relevant team member.","将邮件转发给相关团队成员。"],
  [734,"CC","see-see","抄送","软件操作","CC your manager on all client emails.","在所有客户邮件中抄送你的经理。"],
  [735,"BCC","bee-see-see","密送","软件操作","BCC yourself to keep a copy in your personal mailbox.","密送给自己以在个人邮箱中保留一份副本。"],
  [736,"Attachment","uh-TACH-ment","附件","软件操作","The file is too large to send as an attachment.","该文件太大，无法作为附件发送。"],
  [737,"Subject","SUB-jekt","邮件主题","软件操作","Write a clear subject line to get a faster reply.","写一个清晰的主题行以获得更快的回复。"],
  [738,"Signature","SIG-nuh-cher","邮件签名","软件操作","Add your contact details to your email signature.","将你的联系方式添加到邮件签名中。"],
  [739,"Newsletter","NOOZ-let-er","新闻通讯/订阅邮件","软件操作","Sign up for the newsletter to get weekly updates.","订阅新闻通讯以获取每周更新。"],
  [740,"Sign Up","syn up","注册","软件操作","Sign up for a free account to get started.","注册一个免费账户开始使用。"],
  [741,"Log Out","log owt","退出登录","软件操作","Always log out when using a shared computer.","在使用共享电脑时务必退出登录。"],
  [742,"Forgot Password","for-GOT PAS-werd","忘记密码","软件操作","Click Forgot Password to reset your credentials.","点击忘记密码重置你的凭据。"],
  [743,"Two-Factor Authentication","too-FAK-ter aw-then-tih-KAY-shun","双重认证（2FA）","软件操作","Enable two-factor authentication for better security.","启用双重认证以提高安全性。"],
  [744,"Privacy Policy","PRY-vuh-see POL-ih-see","隐私政策","软件操作","Read the privacy policy to understand how your data is used.","阅读隐私政策了解你的数据如何被使用。"],
  [745,"Terms of Service","termz uv SER-vis","服务条款","软件操作","You must agree to the terms of service to continue.","你必须同意服务条款才能继续。"],
  [746,"Free Trial","free TRY-ul","免费试用","软件操作","Start a 14-day free trial with no credit card required.","开始14天免费试用，无需信用卡。"],
  [747,"Subscription","sub-SKRIP-shun","订阅计划","软件操作","Upgrade your subscription to unlock all features.","升级你的订阅计划以解锁所有功能。"],
  [748,"Billing","BIL-ing","账单管理","软件操作","Go to Billing to update your payment method.","前往账单管理更新你的支付方式。"],
  [749,"Invoice","IN-voys","发票","软件操作","Download your invoice from the billing section.","从账单部分下载你的发票。"],
  [750,"Dark Mode","dark mohd","暗黑模式","软件操作","Switch to dark mode to reduce eye strain at night.","切换到暗黑模式减少夜间眼睛疲劳。"],

  // ── 加密交易所界面 ───────────────────────────────────────────────────────
  [751,"Cross Margin","kros MAR-jin","全仓保证金","加密货币","In cross margin mode, all funds share the same margin pool.","在全仓模式下，所有资金共用同一保证金池。"],
  [752,"Isolated Margin","EYE-suh-lay-tid MAR-jin","逐仓保证金","加密货币","Use isolated margin to limit your risk to one position.","使用逐仓保证金将风险限制在单个仓位上。"],
  [753,"Unrealized PnL","un-REE-uh-lyzd pee-en-el","未实现盈亏","加密货币","Your unrealized PnL shows how much you would make if you close now.","未实现盈亏显示你现在平仓能赚多少。"],
  [754,"Realized PnL","REE-uh-lyzd pee-en-el","已实现盈亏","加密货币","Check realized PnL to see your actual profit for the month.","查看已实现盈亏了解本月实际利润。"],
  [755,"Entry Price","EN-tree prys","入场价格","加密货币","My entry price for BTC was $95,000.","我进入BTC的入场价格是95,000美元。"],
  [756,"Mark Price","mark prys","标记价格","加密货币","The mark price is used to calculate unrealized PnL.","标记价格用于计算未实现盈亏。"],
  [757,"Liquidation Price","lik-wid-AY-shun prys","强平价格","加密货币","If BTC drops to my liquidation price, my position will be closed.","如果BTC跌到我的强平价格，我的仓位将被强制平仓。"],
  [758,"Maintenance Margin","MAYN-tuh-nuns MAR-jin","维持保证金","加密货币","Keep your margin above the maintenance margin to avoid liquidation.","保持保证金高于维持保证金以避免强平。"],
  [759,"Maker","MAY-ker","挂单方（较低手续费）","加密货币","Maker orders provide liquidity and pay lower fees.","挂单方提供流动性并支付较低手续费。"],
  [760,"Taker","TAY-ker","吃单方（较高手续费）","加密货币","Taker orders execute immediately but pay higher fees.","吃单方立即成交但支付较高手续费。"],
  [761,"Withdraw","with-DRAW","提币","加密货币","Withdraw your funds to a cold wallet for safety.","将你的资金提币到冷钱包以确保安全。"],
  [762,"Deposit","dih-POZ-it","充币 / 存入","加密货币","Deposit USDT to start trading on the exchange.","充入USDT开始在交易所交易。"],
  [763,"Transfer","TRANS-fer","划转","加密货币","Transfer funds from your spot account to your futures account.","将资金从现货账户划转到合约账户。"],
  [764,"Available Balance","uh-VAY-luh-bul BAL-uns","可用余额","加密货币","Your available balance is the amount you can trade right now.","可用余额是你现在可以交易的金额。"],
  [765,"Frozen","FROH-zen","冻结资金","加密货币","The funds are frozen because an open order is using them.","资金被冻结，因为有未成交的挂单正在使用它们。"],
  [766,"KYC","kay-why-see","身份认证","加密货币","Complete KYC to unlock higher withdrawal limits.","完成身份认证以解锁更高的提款限额。"],
  [767,"Sub-account","SUB-uh-kownt","子账户","加密货币","Create a sub-account to separate your strategies.","创建子账户以分隔你的策略。"],
  [768,"Trailing Stop","TRAY-ling stop","追踪止损","加密货币","A trailing stop follows the price up and locks in profits.","追踪止损跟随价格上涨并锁定利润。"],
  [769,"OCO Order","oh-see-oh OR-der","二选一委托单","加密货币","Set an OCO order to take profit or cut loss automatically.","设置OCO委托单自动止盈或止损。"],
  [770,"Post Only","pohst OH-nlee","只挂单模式","加密货币","Enable Post Only to always pay maker fees.","启用只挂单模式始终支付挂单手续费。"],
  [771,"Fee Rate","fee rayt","手续费率","加密货币","VIP users get a lower fee rate on the exchange.","VIP用户在交易所享有更低的手续费率。"],
  [772,"Average Cost","AV-er-ij kost","平均持仓成本","加密货币","My average cost for ETH is $3,200 after DCA.","定投后我持有ETH的平均成本是3,200美元。"],

  // ── 加密CT用语 ───────────────────────────────────────────────────────────
  [773,"WAGMI","wag-mee","我们都会成功的","加密货币","Stay strong — WAGMI, just hold your position.","保持坚强——我们都会成功的，坚持你的仓位。"],
  [774,"NGMI","en-jee-em-eye","不会成功的（嘲讽）","加密货币","If you sold the bottom, you are NGMI.","如果你在最低点卖出了，你不会成功的。"],
  [775,"Degen","DEE-jen","投机老手（冒险者）","加密货币","Only a true degen would ape into that project.","只有真正的冒险者才会冲进那个项目。"],
  [776,"Ape In","ayp in","冲动跟风入场","加密货币","He aped in without reading the whitepaper.","他没有阅读白皮书就跟风入场了。"],
  [777,"Rekt","rekt","爆仓了 / 亏惨了","加密货币","He used 50x leverage and got completely rekt.","他使用50倍杠杆，彻底爆仓了。"],
  [778,"Diamond Hands","DY-mund handz","钻石手（坚定持有不卖）","加密货币","Diamond hands never sell during a dip.","钻石手在回调时从不卖出。"],
  [779,"Paper Hands","PAY-per handz","纸手（一跌就卖）","加密货币","Paper hands sold at the bottom and missed the recovery.","纸手在底部卖出，错过了反弹。"],
  [780,"Pump","pump","拉盘","加密货币","The token pumped 300% after the listing announcement.","代币在上市公告后拉盘300%。"],
  [781,"Dump","dump","砸盘","加密货币","The price dumped right after the team unlocked their tokens.","团队解锁代币后价格立即砸盘。"],
  [782,"Bagholder","BAG-hohl-der","深度套牢的人","加密货币","He bought the top and is now a bagholder.","他在顶部买入，现在被深度套牢了。"],
  [783,"LFG","el-ef-jee","冲啊！出发了！","加密货币","BTC just broke $100k — LFG!","BTC刚刚突破10万美元——冲啊！"],
  [784,"NFA","en-ef-ay","非投资建议","加密货币","I'm bullish on this token, but NFA — do your own research.","我看涨这个代币，但这不是投资建议——自己研究。"],
  [785,"DYOR","dee-why-oh-ar","自己做研究","加密货币","Never invest based on hype alone — always DYOR.","永远不要仅凭炒作投资——始终自己做研究。"],
  [786,"Shill","shil","鼓吹项目（有利益驱动）","加密货币","Be careful — that influencer is shilling a paid project.","小心——那个网红在鼓吹一个付费项目。"],
  [787,"Cope","kohp","安慰自己（不愿接受现实）","加密货币","Saying the crash is just manipulation is just cope.","说崩盘只是操纵只是在安慰自己。"],
  [788,"Alpha","AL-fuh","内幕信息 / 先机","加密货币","This wallet found alpha before everyone else and made 100x.","这个钱包比所有人都先找到先机，赚了100倍。"],
  [789,"Probably Nothing","PROB-uh-blee NUTH-ing","可能没什么（反讽大事要发生）","加密货币","BlackRock filed for a Bitcoin ETF — probably nothing.","贝莱德申请了比特币ETF——可能没什么。"],
  [790,"GM","jee-em","早安（加密圈打招呼）","加密货币","GM everyone — let's see what the market brings today.","大家早安——看看今天市场带来什么。"],

  // ── 期权交易 ──────────────────────────────────────────────────────────────
  [791,"Call Option","kawl OP-shun","看涨期权","期权交易","Buy a call option if you expect the price to rise.","如果你预期价格上涨，买入看涨期权。"],
  [792,"Put Option","put OP-shun","看跌期权","期权交易","Buy a put option to profit from a price decline.","买入看跌期权以从价格下跌中获利。"],
  [793,"Strike Price","stryk prys","行权价格","期权交易","Choose a strike price close to the current market price.","选择接近当前市场价格的行权价格。"],
  [794,"Expiration Date","eks-pir-AY-shun dayt","到期日","期权交易","The option expires worthless if not exercised by the expiration date.","如果在到期日前未行权，期权将到期作废。"],
  [795,"Premium","PREE-mee-um","期权权利金","期权交易","The premium is the price you pay to buy the option.","权利金是你购买期权所支付的价格。"],
  [796,"In the Money","in thuh MUN-ee","实值期权（有内在价值）","期权交易","A call option is in the money when the price is above the strike.","当价格高于行权价时，看涨期权处于实值状态。"],
  [797,"Out of the Money","owt uv thuh MUN-ee","虚值期权（无内在价值）","期权交易","Out of the money options are cheaper but less likely to profit.","虚值期权更便宜，但获利可能性较小。"],
  [798,"Delta","DEL-tuh","Delta值（价格敏感度）","期权交易","A delta of 0.5 means the option moves $0.50 for every $1 move.","Delta值为0.5意味着价格每移动1美元，期权移动0.50美元。"],
  [799,"Theta","THAY-tuh","Theta值（时间衰减）","期权交易","Theta decay accelerates as the option approaches expiration.","随着期权接近到期，Theta衰减加速。"],
  [800,"Implied Volatility","im-PLYD vol-uh-TIL-ih-tee","隐含波动率（IV）","期权交易","High implied volatility makes options more expensive.","高隐含波动率使期权更加昂贵。"],
  [801,"Options Chain","OP-shunz chayn","期权链","期权交易","View the options chain to see all available strike prices.","查看期权链以了解所有可用的行权价格。"],
  [802,"Exercise","EK-ser-syz","行权","期权交易","Exercise your option before the expiration date.","在到期日之前行权。"],
  [803,"Covered Call","KUV-erd kawl","备兑看涨期权","期权交易","Sell a covered call to earn extra income from your holdings.","卖出备兑看涨期权以从持仓中赚取额外收入。"],
  [804,"Straddle","STRAD-ul","跨式期权策略","期权交易","A straddle profits when the price moves sharply in either direction.","跨式策略在价格向任一方向大幅移动时获利。"],
  [805,"Iron Condor","EYE-ern KON-dor","铁鹰式期权策略","期权交易","An iron condor profits when the price stays in a range.","铁鹰式策略在价格保持在区间内时获利。"],
  [806,"Gamma","GAM-uh","Gamma值（Delta变化率）","期权交易","High gamma means delta changes rapidly as price moves.","高Gamma值意味着随着价格变动，Delta变化迅速。"],
  [807,"Vega","VAY-guh","Vega值（波动率敏感度）","期权交易","High vega means the option is very sensitive to volatility changes.","高Vega值意味着期权对波动率变化非常敏感。"],
  [808,"Max Pain","maks payn","最大痛苦价（期权）","期权交易","The max pain level is where most options expire worthless.","最大痛苦价是大多数期权到期时一文不值的价格水平。"],

  // ── 量化交易 ──────────────────────────────────────────────────────────────
  [809,"Signal","SIG-nul","交易信号","量化交易","The strategy generates a buy signal when RSI crosses 30.","当RSI穿越30时，策略产生买入信号。"],
  [810,"Drawdown","DRAW-down","回撤","量化交易","A 20% drawdown is common even in profitable strategies.","即使在盈利策略中，20%的回撤也很常见。"],
  [811,"Maximum Drawdown","MAK-sih-mum DRAW-down","最大回撤","量化交易","Keep the maximum drawdown below 15% for a good strategy.","好的策略最大回撤应保持在15%以下。"],
  [812,"Sharpe Ratio","sharp RAY-shee-oh","夏普比率","量化交易","A Sharpe ratio above 1 indicates good risk-adjusted returns.","夏普比率高于1表明良好的风险调整后回报。"],
  [813,"Win Rate","win rayt","胜率","量化交易","A 60% win rate with a 2:1 reward ratio is very profitable.","60%胜率配合2:1的盈亏比非常盈利。"],
  [814,"Risk Reward Ratio","risk rih-WORD RAY-shee-oh","风险收益比","量化交易","Always aim for a risk reward ratio of at least 2:1.","始终追求至少2:1的风险收益比。"],
  [815,"Position Sizing","puh-ZI-shun SY-zing","仓位管理","量化交易","Proper position sizing protects you from blowing up your account.","合理的仓位管理保护你的账户不被爆仓。"],
  [816,"Overfitting","OH-ver-fit-ing","过拟合","量化交易","Overfitting happens when a strategy only works on historical data.","过拟合发生在策略只对历史数据有效时。"],
  [817,"Paper Trading","PAY-per TRAY-ding","模拟交易","量化交易","Paper trade for 3 months before risking real money.","在冒真实资金风险之前模拟交易3个月。"],
  [818,"Mean Reversion","meen rih-VER-zhun","均值回归","量化交易","Mean reversion strategies profit when prices return to average.","均值回归策略在价格返回均值时获利。"],
  [819,"Momentum Strategy","moh-MEN-tum STRAT-uh-jee","动量策略","量化交易","A momentum strategy buys assets that are trending strongly.","动量策略买入趋势强劲的资产。"],
  [820,"Arbitrage","AR-bih-trahj","套利","量化交易","Arbitrage exploits price differences across different exchanges.","套利利用不同交易所之间的价格差异。"],
  [821,"Equity Curve","EK-wih-tee kerv","资金曲线","量化交易","A smooth equity curve shows a consistent strategy.","平滑的资金曲线显示策略稳定一致。"],
  [822,"Profit Factor","PROF-it FAK-ter","盈利因子","量化交易","A profit factor above 1.5 indicates a good trading system.","盈利因子高于1.5表明交易系统良好。"],
  [823,"High Frequency Trading","hy FREE-kwen-see TRAY-ding","高频交易（HFT）","量化交易","High frequency trading executes thousands of orders per second.","高频交易每秒执行数千笔订单。"],
  [824,"Execution","ek-sih-KYOO-shun","交易执行","量化交易","Poor execution can turn a winning strategy into a losing one.","糟糕的执行可能把盈利策略变成亏损策略。"],

  // ── 财报分析 ──────────────────────────────────────────────────────────────
  [825,"Income Statement","IN-kum STAYT-ment","利润表","财报分析","The income statement shows revenue, costs, and net profit.","利润表显示营收、成本和净利润。"],
  [826,"Gross Profit","grohs PROF-it","毛利润","财报分析","Gross profit is revenue minus the cost of goods sold.","毛利润是营收减去销售成本。"],
  [827,"Gross Margin","grohs MAR-jin","毛利率","财报分析","A gross margin above 50% is excellent for software companies.","软件公司毛利率超过50%非常优秀。"],
  [828,"Operating Income","OP-er-ay-ting IN-kum","营业利润","财报分析","Operating income shows profitability before interest and taxes.","营业利润显示利息和税前的盈利能力。"],
  [829,"EBITDA","ee-bit-duh","息税折旧摊销前利润","财报分析","EBITDA is used to compare profitability across companies.","EBITDA用于比较不同公司之间的盈利能力。"],
  [830,"Net Income","net IN-kum","净利润","财报分析","Net income is the profit left after all expenses and taxes.","净利润是扣除所有费用和税款后剩余的利润。"],
  [831,"Net Margin","net MAR-jin","净利率","财报分析","Apple has one of the highest net margins in the industry.","苹果公司拥有行业内最高的净利率之一。"],
  [832,"Operating Expenses","OP-er-ay-ting ek-SPEN-siz","运营费用","财报分析","Operating expenses include salaries, rent, and marketing costs.","运营费用包括薪资、租金和营销成本。"],
  [833,"R&D Expenses","ar-en-dee ek-SPEN-siz","研发费用","财报分析","The company invested 20% of revenue in R&D expenses.","该公司将20%的营收投入研发费用。"],
  [834,"SG&A","es-jee-en-ay","销售及管理费用","财报分析","High SG&A expenses can eat into profit margins.","高销售及管理费用会侵蚀利润率。"],
  [835,"Depreciation","dih-pree-shee-AY-shun","折旧","财报分析","Depreciation spreads the cost of assets over their useful life.","折旧将资产成本分摊到其使用寿命期间。"],
  [836,"Amortization","uh-mor-tih-ZAY-shun","摊销","财报分析","Amortization applies to intangible assets like patents.","摊销适用于专利等无形资产。"],
  [837,"Free Cash Flow","free kash floh","自由现金流","财报分析","Free cash flow is the best measure of a company's financial health.","自由现金流是衡量公司财务健康状况的最佳指标。"],
  [838,"CapEx","KAP-eks","资本支出","财报分析","CapEx is money spent on physical assets like equipment.","资本支出是花在设备等实物资产上的资金。"],
  [839,"Working Capital","WER-king KAP-ih-tul","营运资金","财报分析","Positive working capital means the company can pay short-term debts.","正向营运资金意味着公司可以支付短期债务。"],
  [840,"Accounts Receivable","uh-KOWNTS rih-SEE-vuh-bul","应收账款","财报分析","High accounts receivable can signal collection problems.","高应收账款可能表明收款困难。"],
  [841,"Accounts Payable","uh-KOWNTS PAY-uh-bul","应付账款","财报分析","Accounts payable is money the company owes to suppliers.","应付账款是公司欠供应商的资金。"],
  [842,"Long-term Debt","long-term det","长期债务","财报分析","A high long-term debt load increases financial risk.","高长期债务负担增加了财务风险。"],
  [843,"Shareholder Equity","SHAIR-hohl-der EK-wih-tee","股东权益","财报分析","Shareholder equity is total assets minus total liabilities.","股东权益是总资产减去总负债。"],
  [844,"Return on Equity","rih-TERN on EK-wih-tee","净资产收益率（ROE）","财报分析","A ROE above 15% is considered strong.","ROE高于15%被认为表现强劲。"],
  [845,"Return on Assets","rih-TERN on AS-ets","资产回报率（ROA）","财报分析","ROA measures how efficiently a company uses its assets.","ROA衡量公司使用其资产的效率。"],
  [846,"Earnings Call","ER-ningz kawl","财报电话会议","财报分析","Listen to the earnings call to hear management's outlook.","收听财报电话会议了解管理层的展望。"],
  [847,"Year over Year","yeer OH-ver yeer","同比（YoY）","财报分析","Revenue grew 35% year over year.","营收同比增长35%。"],
  [848,"Quarter over Quarter","KWOR-ter OH-ver KWOR-ter","环比（QoQ）","财报分析","Profit improved 8% quarter over quarter.","利润环比改善8%。"],
  [849,"Forward P/E","FOR-werd pee-ee","预期市盈率","财报分析","The forward P/E reflects expected future earnings.","预期市盈率反映预期的未来盈利。"],
  [850,"PEG Ratio","peg RAY-shee-oh","市盈增长比率","财报分析","A PEG ratio below 1 suggests the stock may be undervalued.","PEG比率低于1表明该股票可能被低估。"],
  [851,"Price to Book","prys tuh buk","市净率（P/B）","财报分析","A price to book ratio below 1 means the stock trades below asset value.","市净率低于1意味着股票的交易价格低于资产价值。"],
  [852,"Price to Sales","prys tuh saylz","市销率（P/S）","财报分析","Price to sales is useful for valuing companies with no profit yet.","市销率对于估值尚未盈利的公司很有用。"],
  [853,"Short Interest","short IN-ter-est","空头持仓比例","财报分析","High short interest can lead to a short squeeze rally.","高空头持仓比例可能导致轧空反弹。"],
  [854,"Insider Buying","IN-sy-der BY-ing","内部人买入","财报分析","Insider buying is a bullish signal about the company's future.","内部人买入是对公司未来的看涨信号。"],

  // ── TradingView 专项 ─────────────────────────────────────────────────────
  [855,"Trendline","TREND-lyne","趋势线","股票金融","Draw a trendline connecting the higher lows.","画一条连接更高低点的趋势线。"],
  [856,"Fibonacci Retracement","fib-uh-NAH-chee rih-TRAYT-ment","斐波那契回调","股票金融","The 61.8% Fibonacci retracement is the golden ratio level.","61.8%斐波那契回调是黄金比率水平。"],
  [857,"Pine Script","pyn skript","Pine Script编程语言","股票金融","Write a Pine Script strategy to automate your signals.","编写Pine Script策略来自动化你的信号。"],
  [858,"Strategy Tester","STRAT-uh-jee TES-ter","策略回测器","股票金融","Use the strategy tester to see how your system performed historically.","使用策略回测器查看你的系统历史表现。"],
  [859,"Screener","SKREE-ner","选股筛选器","股票金融","Use the screener to filter stocks by RSI and volume.","使用选股筛选器按RSI和成交量筛选股票。"],
  [860,"Log Scale","log skayl","对数刻度","股票金融","Switch to log scale to better visualize long-term price growth.","切换到对数刻度以更好地可视化长期价格增长。"],
  [861,"Auto Scale","AW-toh skayl","自动刻度","股票金融","Enable auto scale to fit all price action on the chart.","启用自动刻度使所有价格行为适合图表显示。"],
  [862,"Volume Profile","VOL-yoom PROH-fyl","成交量分布","股票金融","Volume profile shows where most trading activity occurred.","成交量分布显示大多数交易活动发生的位置。"],
  [863,"Elliott Wave","EL-ee-ut wayv","艾略特波浪理论","股票金融","Elliott Wave theory predicts price cycles in 5 waves.","艾略特波浪理论以5浪预测价格周期。"],
  [864,"Pitchfork","PICH-fork","叉形工具","股票金融","Use the pitchfork to identify a trending channel.","使用叉形工具识别趋势通道。"],
  [865,"Multi-timeframe","MUL-tee-TYM-fraym","多时间框架分析","股票金融","Always confirm signals using multi-timeframe analysis.","始终使用多时间框架分析确认信号。"],
  [866,"Higher High","HY-er hy","更高高点（上升趋势）","股票金融","A series of higher highs confirms an uptrend.","一系列更高高点确认上升趋势。"],
  [867,"Lower Low","LOH-er loh","更低低点（下降趋势）","股票金融","Lower lows and lower highs define a downtrend.","更低低点和更低高点定义下降趋势。"],
  [868,"Consolidation","kun-sol-ih-DAY-shun","盘整","股票金融","The price is in consolidation before the next big move.","价格在下一次大行情之前处于盘整阶段。"],
  [869,"Divergence","dy-VER-juns","背离","股票金融","RSI divergence often precedes a trend reversal.","RSI背离通常预示趋势反转。"],

  // ── AI 行业深度扩展 ───────────────────────────────────────────────────────
  [870,"Machine Learning","muh-SHEEN LER-ning","机器学习","AI行业","Machine learning enables systems to learn from data automatically.","机器学习使系统能够自动从数据中学习。"],
  [871,"Deep Learning","deep LER-ning","深度学习","AI行业","Deep learning powers modern image recognition systems.","深度学习驱动现代图像识别系统。"],
  [872,"Computer Vision","kum-PYOO-ter VI-zhun","计算机视觉","AI行业","Computer vision allows AI to analyze and understand images.","计算机视觉使AI能够分析和理解图像。"],
  [873,"Natural Language Processing","NACH-er-ul LANG-gwij PRAH-ses-ing","自然语言处理（NLP）","AI行业","Natural language processing powers chatbots and translation tools.","自然语言处理驱动聊天机器人和翻译工具。"],
  [874,"Generative AI","JEN-er-uh-tiv ay-eye","生成式AI","AI行业","Generative AI can create text, images, and videos from scratch.","生成式AI可以从零开始创建文字、图像和视频。"],
  [875,"Diffusion Model","dih-FYOO-zhun MOD-ul","扩散模型","AI行业","Stable Diffusion is an open-source diffusion model for images.","Stable Diffusion是一个用于图像生成的开源扩散模型。"],
  [876,"Text to Image","tekst tuh IM-ij","文字生成图片","AI行业","Use text to image AI to create visuals from a description.","使用文字生成图片AI从描述创建视觉内容。"],
  [877,"Text to Video","tekst tuh VID-ee-oh","文字生成视频","AI行业","Text to video AI like Sora can produce realistic video clips.","像Sora这样的文字生成视频AI可以制作逼真的视频片段。"],
  [878,"Voice Cloning","voys KLOHN-ing","声音克隆","AI行业","Voice cloning can replicate any speaker's voice in seconds.","声音克隆可以在几秒内复制任何说话者的声音。"],
  [879,"Speech to Text","speech tuh tekst","语音转文字","AI行业","Speech to text tools transcribe meetings automatically.","语音转文字工具自动转录会议内容。"],
  [880,"Chain of Thought","chayn uv thawt","思维链（推理方式）","AI行业","Chain of thought prompting improves complex reasoning.","思维链提示改善复杂推理能力。"],
  [881,"Zero-shot","ZEE-roh-shot","零样本（无需示例）","AI行业","Zero-shot prompting asks the model to answer without examples.","零样本提示要求模型无需示例直接回答。"],
  [882,"Few-shot","fyoo-shot","少样本（提供少量示例）","AI行业","Few-shot prompting provides a few examples to guide the model.","少样本提示提供少量示例来引导模型。"],
  [883,"Knowledge Base","NOL-ij bays","知识库","AI行业","Build a knowledge base so the AI can answer company-specific questions.","构建知识库让AI能够回答公司特定问题。"],
  [884,"Automation","aw-tuh-MAY-shun","自动化","AI行业","AI automation saves hours of manual work every day.","AI自动化每天节省数小时的人工工作。"],
  [885,"Perplexity","per-PLEKS-ih-tee","Perplexity（AI搜索引擎）","AI行业","Use Perplexity as an AI-powered alternative to Google Search.","使用Perplexity作为谷歌搜索的AI驱动替代品。"],
  [886,"Midjourney","MID-jer-nee","Midjourney（AI绘图工具）","AI行业","Midjourney generates stunning images from text prompts.","Midjourney从文字提示生成令人惊叹的图像。"],
  [887,"Stable Diffusion","STAY-bul dih-FYOO-zhun","Stable Diffusion（开源AI绘图）","AI行业","Stable Diffusion is free and can run locally on your computer.","Stable Diffusion是免费的，可以在你的电脑上本地运行。"],
  [888,"ElevenLabs","EL-ev-en-labz","ElevenLabs（AI配音工具）","AI行业","ElevenLabs creates realistic voice overs for videos.","ElevenLabs为视频创建逼真的配音。"],
  [889,"Sora","SOR-uh","Sora（OpenAI视频生成）","AI行业","Sora can generate realistic 1-minute videos from text.","Sora可以从文字生成长达1分钟的逼真视频。"],
  [890,"DeepSeek","DEEP-seek","DeepSeek（中国AI模型）","AI行业","DeepSeek released a powerful open-source model that rivaled GPT-4.","DeepSeek发布了一个能与GPT-4媲美的强大开源模型。"],
  [891,"Grok","grok","Grok（xAI模型）","AI行业","Grok is xAI's model that has access to real-time X data.","Grok是xAI的模型，可以访问X的实时数据。"],
  [892,"n8n","en-ayt-en","n8n（AI自动化工具）","AI行业","Use n8n to build AI automation workflows without coding.","使用n8n无需编码即可构建AI自动化工作流。"],
  [893,"Accuracy","AK-yuh-ruh-see","准确率","AI行业","The model achieved 95% accuracy on the benchmark test.","该模型在基准测试中达到了95%的准确率。"],
  [894,"Alignment","uh-LYN-ment","AI价值观对齐","AI行业","Alignment ensures AI behaves in line with human values.","对齐确保AI行为符合人类价值观。"],
  [895,"Safety","SAYF-tee","AI安全性","AI行业","AI safety research focuses on preventing harmful outputs.","AI安全研究专注于防止有害输出。"],

  // ── 通用词汇扩展 ─────────────────────────────────────────────────────────
  [896,"Cache","kash","缓存","通用","Clear the cache to fix display issues.","清除缓存以修复显示问题。"],
  [897,"Clear Cache","kleer kash","清除缓存","通用","If the app is slow, try clearing the cache first.","如果应用运行缓慢，先尝试清除缓存。"],
  [898,"Bandwidth","BAND-width","带宽","通用","Streaming 4K video requires a lot of bandwidth.","流式传输4K视频需要大量带宽。"],
  [899,"Offline","OF-lyne","离线","通用","You can access some features offline without internet.","你可以在没有网络的情况下离线访问某些功能。"],
  [900,"Sync","sink","同步","通用","Sync your notes across all your devices automatically.","自动在所有设备上同步你的笔记。"],
  [901,"Cloud Storage","klowd STOR-ij","云端存储","通用","Back up your files to cloud storage for easy access.","将你的文件备份到云端存储以便轻松访问。"],
  [902,"Permission Denied","per-MISH-un dih-NYED","权限被拒","通用","Permission denied — contact your admin for access.","权限被拒——联系你的管理员获取访问权限。"],
  [903,"Access","AK-ses","访问权限","通用","You do not have access to this file.","你没有访问此文件的权限。"],
  [904,"Embed","em-BED","嵌入","通用","Embed the video directly into your website.","将视频直接嵌入你的网站。"],
  [905,"File Format","fyl FOR-mat","文件格式","通用","Make sure you save in the correct file format.","确保以正确的文件格式保存。"],
  [906,"Compress","kum-PRES","压缩","通用","Compress the file before uploading to save time.","上传前压缩文件以节省时间。"],
  [907,"Pro Plan","proh plan","专业版计划","通用","Upgrade to the Pro Plan to remove the watermark.","升级到专业版计划以去除水印。"],
  [908,"Enterprise","EN-ter-pryz","企业版","通用","The enterprise plan includes dedicated support.","企业版包含专属支持服务。"],
  [909,"Upgrade","UP-grayd","升级","通用","Upgrade your plan to get more storage space.","升级你的计划以获得更多存储空间。"],
  [910,"Downgrade","DOWN-grayd","降级","通用","You can downgrade your plan at any time.","你可以随时降级你的计划。"],
  [911,"Payment Method","PAY-ment METH-ud","支付方式","通用","Add a payment method to activate your subscription.","添加支付方式以激活你的订阅。"],
  [912,"Crash","krash","程序崩溃","通用","The app crashed and I lost all my unsaved work.","应用崩溃了，我丢失了所有未保存的工作。"],
  [913,"Bug","bug","程序错误","通用","Report the bug to the developer so they can fix it.","向开发者报告错误以便他们修复。"],
  [914,"Glitch","glich","小故障","通用","There was a glitch and the screen went blank.","出现了一个小故障，屏幕变黑了。"],
  [915,"Performance","per-FOR-muns","性能","通用","The app's performance improved after the update.","更新后应用的性能有所提升。"],
  [916,"Latency","LAY-ten-see","网络延迟","通用","High latency makes video calls choppy and delayed.","高网络延迟使视频通话卡顿和延迟。"],
  [917,"Update Available","UP-dayt uh-VAY-luh-bul","有可用更新","通用","A new update is available — install it for the latest fixes.","有新的更新可用——安装它以获取最新修复。"],
  [918,"Install","in-STAWL","安装","通用","Install the app from the official website.","从官方网站安装该应用。"],
  [919,"Uninstall","un-in-STAWL","卸载","通用","Uninstall the old version before installing the new one.","在安装新版本之前卸载旧版本。"],
  [920,"Loading Speed","LOH-ding speed","加载速度","通用","A slow loading speed will cause users to leave.","加载速度慢会导致用户离开。"],
  [921,"Screenshot","SKREEN-shot","截图","通用","Take a screenshot and share it with the support team.","截图并将其分享给支持团队。"],
  [922,"Copy Link","KOP-ee link","复制链接","通用","Click Copy Link to share the page with others.","点击复制链接与他人分享该页面。"],
  [923,"Open in Browser","OH-pen in BROW-zer","在浏览器中打开","通用","Open in browser if the app is not working.","如果应用无法使用，在浏览器中打开。"],
  [924,"Read More","reed mor","阅读更多","通用","Click Read More to see the full article.","点击阅读更多查看完整文章。"],
  [925,"See All","see awl","查看全部","通用","Click See All to view every item in the list.","点击查看全部以查看列表中的所有项目。"],
  [926,"Get Started","get STAR-tid","开始使用","通用","Click Get Started to create your first project.","点击开始使用创建你的第一个项目。"],
  [927,"Learn More","lern mor","了解更多","通用","Click Learn More to read the full feature description.","点击了解更多阅读完整功能描述。"],
  [928,"Contact Support","KON-takt suh-PORT","联系客服","通用","Contact support if you cannot resolve the issue yourself.","如果无法自行解决问题，请联系客服。"],
  [929,"FAQ","ef-ay-kyoo","常见问题解答","通用","Check the FAQ section before contacting support.","在联系客服之前查看常见问题解答部分。"],
  [930,"Changelog","CHAYNJ-log","更新日志","通用","Read the changelog to see what changed in the new version.","阅读更新日志了解新版本中的变化。"],
];
...
const BASE_MOD_COLORS = {
  ...
  '链上分析':'#4ade80','办公软件':'#818cf8','视频创作':'#f87171',
  '期权交易':'#2dd4bf','量化交易':'#facc15','财报分析':'#a3e635'
};
